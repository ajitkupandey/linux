...
#define I2S_DMIC_INSTANCE	2

#define I2S_MODE		0x04

int renoir_dai_probe(struct snd_soc_dai *dai)
{
	...
	if (val != I2S_MODE) {
		dev_err(sdev->dev, "I2S Mode not supported val %x\n", val);
		return -1;
	}
...
void amd_sof_machine_select(struct snd_sof_dev *sdev)
{
